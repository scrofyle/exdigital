...
// Buscar eventos pendentes de pagamento
$stmt = $db->prepare("
    SELECT COUNT(*) as total 
    FROM eventos 
    WHERE cliente_id = ? 
...
");
$stmt->execute([$userId]);
$eventosPendentes = $stmt->fetchColumn();
...
<head>
    ...
    <title><?php echo SITE_NAME; ?> - Cliente</title>
    <link rel="stylesheet" href="<?php echo asset('css/style.css'); ?>">
    <link rel="stylesheet" href="<?php echo asset('css/cliente.css'); ?>">
    ...
    <div class="wrapper">
        ...
        <aside class="sidebar" id="sidebar">
            <div class="sidebar-header">
                ...
                <div class="sidebar-subtitle">Área do Cliente</div>
            </div>
            ...
            <ul class="sidebar-menu">
                ...
                <li class="sidebar-menu-item">
                    <a href="criar-evento.php" class="sidebar-menu-link <?php echo $currentPage === 'criar-evento' ? 'active' : ''; ?>">
                        <span class="sidebar-menu-icon"><i class="bi bi-plus"></i></span>
                        <span class="sidebar-menu-text">Criar Evento</span>
                    </a>
                </li>
                ...
                <li class="sidebar-menu-item">
                    <a href="pagamentos.php" class="sidebar-menu-link <?php echo $currentPage === 'pagamentos' ? 'active' : ''; ?>">
                        ...
                        <?php if ($eventosPendentes > 0): ?>
                            <span class="sidebar-menu-badge"><?php echo $eventosPendentes; ?></span>
                        <?php endif; ?>
                    </a>
                </li>

                <li class="sidebar-menu-item">
                    <a href="notificacoes.php" class="sidebar-menu-link <?php echo $currentPage === 'notificacoes' ? 'active' : ''; ?>">
                        <span class="sidebar-menu-icon"><i class="bi bi-bell"></i></span>
                        <span class="sidebar-menu-text">Notificações</span>
                ...
                <li class="sidebar-menu-item">
                    <a href="perfil.php" class="sidebar-menu-link <?php echo $currentPage === 'perfil' ? 'active' : ''; ?>">
                        <span class="sidebar-menu-icon"><i class="bi bi-person-fill"></i></span>
                        <span class="sidebar-menu-text">Meu Perfil</span>
                    </a>
                </li>

                <li class="sidebar-menu-item">
                    <a href="ajuda.php" class="sidebar-menu-link <?php echo $currentPage === 'ajuda' ? 'active' : ''; ?>">
                        <span class="sidebar-menu-icon"><i class="bi bi-question"></i></span>
            ...
            <header class="header">
                <div class="header-left">
                    ...
                    <div class="header-search">
                        ...
                        <input type="text" class="header-search-input" placeholder="Buscar eventos...">
                    </div>
                </div>
                ...
                <div class="header-right">
                    ...
                    <div class="dropdown header-user" id="userDropdown">
                        <div class="dropdown-toggle">
                            <img src="<?php echo $cliente['foto_perfil'] ? asset('uploads/perfis/' . $cliente['foto_perfil']) : asset('images/default-avatar.png'); ?>" 
                                 alt="Avatar" class="header-user-avatar">
                            <div class="header-user-info">
                                <div class="header-user-name"><?php echo Security::clean($cliente['nome_completo']); ?></div>
                                <div class="header-user-role">Cliente</div>
                            </div>
                        </div>
                        <div class="dropdown-menu">
                            ...
                            <a href="pagamentos.php" class="dropdown-item">
